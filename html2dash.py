#! /usr/bin/env python
# -*- coding: utf-8 -*-
# Original code from https://github.com/selfboot/html2Dash.git
#
# Modified by Jeremie CUADRADO to use with mkdocs html files...
# v2.0 - 31/08/2019
#
# Actual repo from https://github.com/redbeard28/docset
...
if __name__ == "__main__":
    ...
    # print(os.path.isfile(icon_filename))
    # print(icon_path)
    if icon_filename:
